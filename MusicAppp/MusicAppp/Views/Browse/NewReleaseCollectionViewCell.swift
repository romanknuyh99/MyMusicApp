...
class NewReleaseCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        contentView.addSubview(self.albumCoverImageView)
        contentView.addSubview(self.albumNameLabel)
        contentView.addSubview(self.artistNameLabel)
        contentView.clipsToBounds = true
        contentView.addSubview(self.numberOfTracksLabel)
    }
    ...
    override func layoutSubviews() {
        ...
        let albumLabelSize = albumNameLabel.sizeThatFits(
            CGSize(
                width: contentView.wight-imageSize-10,
        ...
        artistNameLabel.frame = CGRect (x: albumCoverImageView.right+10,
                                        ...
                                        width: contentView.wight - albumCoverImageView.right-10,
                                       height: 30
        )
        
        numberOfTracksLabel.frame = CGRect (x: albumCoverImageView.right+10,
                                            y: contentView.bottom-44,
                                            width: numberOfTracksLabel.wight,
                                            height: 44)
    }
